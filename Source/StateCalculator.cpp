...
namespace GOL {
     ...
     */
    void calculateNextState(array<array<bool, BOARD_SIZE+2>, BOARD_SIZE+2> &p_currentStateBoard){
     ...
     */
    int neighbourTotal(array<array<bool, BOARD_SIZE+2>, BOARD_SIZE+2> &p_currentStateBoard, int p_posX, int p_posY){
